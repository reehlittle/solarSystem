...
// FONT FAMILY
export const FONT_FAMILY_REGULAR = 'Teko-Regular';
export const FONT_FAMILY_BOLD = 'Teko-Bold';

// FONT SIZE
export const FONT_SIZE_120 = scaleFont(120);
export const FONT_SIZE_52 = scaleFont(52);
export const FONT_SIZE_46_N = scaleFont(46, false);
